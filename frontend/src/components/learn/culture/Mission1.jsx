...
import { X, Coffee, Users, ShieldCheck, CheckCircle, ArrowRight, ArrowLeft, Heart, Award } from "lucide-react";
          ...
          {step === "completion" && (
            <div className="completion-step">
              ...
              <div className="next-mission-card">
                <div className="next-icon" style={{ background: "rgba(21,128,61,0.15)", color: "#15803d" }}>
                  <span style={{ fontSize: "1.5rem" }}>🔓</span>
                </div>
                <div className="next-info">
                  <h4>{t("cultureM1NextUnlock")}</h4>
                </div>
              </div>
